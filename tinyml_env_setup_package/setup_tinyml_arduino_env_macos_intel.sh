...
# Stable TinyML Python environment for macOS Intel
# Usage:
#   bash setup_tinyml_arduino_env_macos_intel.sh
#   bash setup_tinyml_arduino_env_macos_intel.sh tinyml-arduino ~/ai/projects
#
...
msg "Preparing stable TinyML environment on macOS Intel: $ENV_NAME"
mkdir -p "$BASE_DIR"
